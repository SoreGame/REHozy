...
namespace REHozy.EditorTools
{
    public static class TorchSceneSetup
    {
        ...
        private static GameObject BuildTorchGameObject(string name)
        {
            ...
            meshGo.transform.SetParent(visualPivotGo.transform, false);
            meshGo.transform.localScale = new Vector3(0.18f, 0.55f, 0.18f);

            var tip = new GameObject("Tip").transform;
            tip.SetParent(visualPivotGo.transform, false);
            tip.localPosition = new Vector3(0f, 0.58f, 0f);
        ...
        private static void AddIgnitionComponents(GameObject fireRoot)
        {
            ...
            source.Configure(fireRoot.transform, 1.75f);
